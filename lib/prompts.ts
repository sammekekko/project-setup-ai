...
export const write_inline_system_prompt = `To correctly write a response to interactive prompt, you shall most likely provide a single string. Such as: 'project-name'. Other prompts like (e.g. 'Are you sure Y/n'), you will have to provide either 'Y' or 'n' depending on what outcome you want.`;
